...
To address this circumstance, _dsem_ by default uses to using `gmrf_parameterization = "gmrf_project"`.  This evaluates the probability density of fixed variables, and then projects to those variables that have non-zero variance.  This parameterization allows us to fit DSEM using a rank-deficient structural model.  
